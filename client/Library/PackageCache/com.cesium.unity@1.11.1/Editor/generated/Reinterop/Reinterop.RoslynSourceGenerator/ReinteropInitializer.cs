    ...
    internal class ReinteropInitializer
    {
        ...
        private static void AddFunctionPointers(IntPtr memory)
        {
            unsafe
            {
                ...
                Marshal.WriteIntPtr(memory, 10 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Cesium3DTileset_Property_get_ionServerDelegate));
                Marshal.WriteIntPtr(memory, 11 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Cesium3DTileset_Property_get_tilesetSourceDelegate));
                Marshal.WriteIntPtr(memory, 12 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Cesium3DTileset_Property_set_ionAccessTokenDelegate));
                Marshal.WriteIntPtr(memory, 13 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Cesium3DTileset_Property_set_ionAssetIDDelegate));
                Marshal.WriteIntPtr(memory, 14 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Cesium3DTileset_Property_set_ionServerDelegate));
                Marshal.WriteIntPtr(memory, 15 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Cesium3DTileset_Property_set_tilesetSourceDelegate));
                Marshal.WriteIntPtr(memory, 16 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumEditorUtility_CallAddBaseOverlayToTileset_GE91HI1OIybUlB1E__yYJCQDelegate));
                Marshal.WriteIntPtr(memory, 17 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumEditorUtility_CallCreateTileset_jsvXjE1xIXP0dz0Yem4NagDelegate));
                Marshal.WriteIntPtr(memory, 18 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumEditorUtility_CallFindFirstTileset_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 19 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumEditorUtility_CallFindFirstTilesetWithAssetID_OUsZiF60__hSy6sWtVPSwsADelegate));
                Marshal.WriteIntPtr(memory, 20 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumEditorWindow_CallClose_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 21 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumEditorWindow_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 22 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumEditorWindow_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 23 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumEditorWindow_Field_get_currentWindowDelegate));
                Marshal.WriteIntPtr(memory, 24 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumEditorWindow_Field_set_currentWindowDelegate));
                Marshal.WriteIntPtr(memory, 25 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumEditorWindow_Property_get_NativeImplementationDelegate));
                Marshal.WriteIntPtr(memory, 26 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonAsset_CallIsNull_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 27 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonAsset_Property_get_componentTypeDelegate));
                Marshal.WriteIntPtr(memory, 28 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonAsset_Property_get_ionAccessTokenDelegate));
                Marshal.WriteIntPtr(memory, 29 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonAsset_Property_get_ionAssetIDDelegate));
                Marshal.WriteIntPtr(memory, 30 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonAsset_Property_get_objectNameDelegate));
                Marshal.WriteIntPtr(memory, 31 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonAsset_Property_get_overlayDelegate));
                Marshal.WriteIntPtr(memory, 32 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonAsset_Property_get_tilesetDelegate));
                Marshal.WriteIntPtr(memory, 33 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonAsset_Property_get_typeDelegate));
                Marshal.WriteIntPtr(memory, 34 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonAsset_Property_set_ionAccessTokenDelegate));
                Marshal.WriteIntPtr(memory, 35 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonRasterOverlay_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 36 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonRasterOverlay_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 37 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonRasterOverlay_CallRefresh_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 38 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonRasterOverlay_Property_get_gameObjectDelegate));
                Marshal.WriteIntPtr(memory, 39 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonRasterOverlay_Property_get_ionAccessTokenDelegate));
                Marshal.WriteIntPtr(memory, 40 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonRasterOverlay_Property_get_ionAssetIDDelegate));
                Marshal.WriteIntPtr(memory, 41 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonRasterOverlay_Property_get_ionServerDelegate));
                Marshal.WriteIntPtr(memory, 42 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonRasterOverlay_Property_set_ionAccessTokenDelegate));
                Marshal.WriteIntPtr(memory, 43 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonRasterOverlay_Property_set_ionAssetIDDelegate));
                Marshal.WriteIntPtr(memory, 44 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonRasterOverlay_Property_set_ionServerDelegate));
                Marshal.WriteIntPtr(memory, 45 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServer_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 46 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServer_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 47 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServer_Field_get_apiUrlDelegate));
                Marshal.WriteIntPtr(memory, 48 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServer_Field_get_defaultIonAccessTokenDelegate));
                Marshal.WriteIntPtr(memory, 49 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServer_Field_get_defaultIonAccessTokenIdDelegate));
                Marshal.WriteIntPtr(memory, 50 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServer_Field_get_oauth2ApplicationIDDelegate));
                Marshal.WriteIntPtr(memory, 51 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServer_Field_get_serverUrlDelegate));
                Marshal.WriteIntPtr(memory, 52 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServer_Field_set_apiUrlDelegate));
                Marshal.WriteIntPtr(memory, 53 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServer_Field_set_defaultIonAccessTokenDelegate));
                Marshal.WriteIntPtr(memory, 54 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServer_Field_set_defaultIonAccessTokenIdDelegate));
                Marshal.WriteIntPtr(memory, 55 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServer_Field_set_oauth2ApplicationIDDelegate));
                Marshal.WriteIntPtr(memory, 56 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServer_Field_set_serverUrlDelegate));
                Marshal.WriteIntPtr(memory, 57 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServerManager_CallGetSession_ouKG7YNdV4bUJcBV0W3dBADelegate));
                Marshal.WriteIntPtr(memory, 58 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServerManager_CallGetUserAccessToken_ouKG7YNdV4bUJcBV0W3dBADelegate));
                Marshal.WriteIntPtr(memory, 59 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServerManager_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 60 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServerManager_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 61 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServerManager_CallSetUserAccessToken_i1OZfOwTwhgNuaqLRy9vZQDelegate));
                Marshal.WriteIntPtr(memory, 62 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServerManager_Property_get_currentDelegate));
                Marshal.WriteIntPtr(memory, 63 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServerManager_Property_get_currentSessionDelegate));
                Marshal.WriteIntPtr(memory, 64 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServerManager_Property_get_instanceDelegate));
                Marshal.WriteIntPtr(memory, 65 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonServerManager_Property_set_currentDelegate));
                Marshal.WriteIntPtr(memory, 66 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonSession_CallBroadcastAssetsUpdate_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 67 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonSession_CallBroadcastConnectionUpdate_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 68 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonSession_CallBroadcastDefaultsUpdate_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 69 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonSession_CallBroadcastProfileUpdate_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 70 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonSession_CallBroadcastTokensUpdate_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 71 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonSession_CallGetQuickAddItems_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 72 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonSession_CallIsConnected_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 73 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonSession_Property_get_NativeImplementationDelegate));
                Marshal.WriteIntPtr(memory, 74 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonSession_Property_get_serverDelegate));
                Marshal.WriteIntPtr(memory, 75 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumIonSession_Property_set_serverDelegate));
                Marshal.WriteIntPtr(memory, 76 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumRasterOverlay_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 77 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumRasterOverlay_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 78 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumRasterOverlay_CallRefresh_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 79 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumRasterOverlay_Property_get_gameObjectDelegate));
                Marshal.WriteIntPtr(memory, 80 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumRuntimeSettings_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 81 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumRuntimeSettings_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 82 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumRuntimeSettings_Property_get_maxItemsDelegate));
                Marshal.WriteIntPtr(memory, 83 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_CesiumRuntimeSettings_Property_get_requestsPerCachePruneDelegate));
                Marshal.WriteIntPtr(memory, 84 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Helpers_CallToString__8pn__Nas4aiRxhf1NkpeKgDelegate));
                Marshal.WriteIntPtr(memory, 85 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonAssetDetails_CallFormatDate_Wg__UxSmEJUgHx3kyfccFEwDelegate));
                Marshal.WriteIntPtr(memory, 86 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonAssetDetails_CallFormatType_3GczHehc_XCRt9ReXGSrdQDelegate));
                Marshal.WriteIntPtr(memory, 87 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonAssetsTreeView_CallReload_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 88 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonAssetsTreeView_Construct_bk3kO2aTAFaE0GWD9sxbigDelegate));
                Marshal.WriteIntPtr(memory, 89 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonAssetsTreeView_Property_get_multiColumnHeaderDelegate));
                Marshal.WriteIntPtr(memory, 90 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonAssetsTreeView_Property_get_NativeImplementationDelegate));
                Marshal.WriteIntPtr(memory, 91 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonAssetsTreeView_Property_get_searchStringDelegate));
                Marshal.WriteIntPtr(memory, 92 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonAssetsTreeView_Property_set_multiColumnHeaderDelegate));
                Marshal.WriteIntPtr(memory, 93 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonAssetsTreeView_Property_set_searchStringDelegate));
                Marshal.WriteIntPtr(memory, 94 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonMissingAssetWindow_CallClose_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 95 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonMissingAssetWindow_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 96 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonMissingAssetWindow_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 97 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonMissingAssetWindow_CallShowWindow_zCuaF57FLiXZD1__wksXLdQDelegate));
                Marshal.WriteIntPtr(memory, 98 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonTokenTroubleshootingWindow_CallClose_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 99 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonTokenTroubleshootingWindow_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 100 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonTokenTroubleshootingWindow_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 101 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonTokenTroubleshootingWindow_CallUseDefaultToken_qpX7eE7SvOg4KIeidX7yngDelegate));
                Marshal.WriteIntPtr(memory, 102 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonTokenTroubleshootingWindow_Property_get_assetDetailsDelegate));
                Marshal.WriteIntPtr(memory, 103 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonTokenTroubleshootingWindow_Property_get_assetTokenDetailsDelegate));
                Marshal.WriteIntPtr(memory, 104 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonTokenTroubleshootingWindow_Property_get_defaultTokenDetailsDelegate));
                Marshal.WriteIntPtr(memory, 105 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonTokenTroubleshootingWindow_Property_get_ionAssetDelegate));
                Marshal.WriteIntPtr(memory, 106 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_IonTokenTroubleshootingWindow_Property_set_ionAssetDelegate));
                Marshal.WriteIntPtr(memory, 107 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_NativeDownloadHandler_CallDispose_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 108 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_NativeDownloadHandler_Construct_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 109 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_NativeDownloadHandler_Property_get_NativeImplementationDelegate));
                Marshal.WriteIntPtr(memory, 110 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_QuickAddItem_Construct_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 111 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_QuickAddItem_Construct_MigqS33KRbgyAt6uiJjTGwDelegate));
                Marshal.WriteIntPtr(memory, 112 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_QuickAddItem_Field_get_nameDelegate));
                Marshal.WriteIntPtr(memory, 113 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_QuickAddItem_Field_get_overlayIdDelegate));
                Marshal.WriteIntPtr(memory, 114 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_QuickAddItem_Field_get_overlayNameDelegate));
                Marshal.WriteIntPtr(memory, 115 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_QuickAddItem_Field_get_tilesetIdDelegate));
                Marshal.WriteIntPtr(memory, 116 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_QuickAddItem_Field_get_tilesetNameDelegate));
                Marshal.WriteIntPtr(memory, 117 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_QuickAddItem_Field_get_tooltipDelegate));
                Marshal.WriteIntPtr(memory, 118 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_QuickAddItem_Field_get_typeDelegate));
                Marshal.WriteIntPtr(memory, 119 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_QuickAddItem_Field_set_nameDelegate));
                Marshal.WriteIntPtr(memory, 120 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_QuickAddItem_Field_set_overlayIdDelegate));
                Marshal.WriteIntPtr(memory, 121 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_QuickAddItem_Field_set_overlayNameDelegate));
                Marshal.WriteIntPtr(memory, 122 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_QuickAddItem_Field_set_tilesetIdDelegate));
                Marshal.WriteIntPtr(memory, 123 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_QuickAddItem_Field_set_tilesetNameDelegate));
                Marshal.WriteIntPtr(memory, 124 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_QuickAddItem_Field_set_tooltipDelegate));
                Marshal.WriteIntPtr(memory, 125 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_QuickAddItem_Field_set_typeDelegate));
                Marshal.WriteIntPtr(memory, 126 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_CallClose_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 127 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_CallGetDefaultNewTokenName_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 128 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_CallGetExistingTokenList_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 129 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 130 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 131 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_CallRefreshExistingTokenList_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 132 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_CallShowWindow_ouKG7YNdV4bUJcBV0W3dBADelegate));
                Marshal.WriteIntPtr(memory, 133 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_Field_get_currentWindowDelegate));
                Marshal.WriteIntPtr(memory, 134 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_Field_get_serverDelegate));
                Marshal.WriteIntPtr(memory, 135 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_Field_set_currentWindowDelegate));
                Marshal.WriteIntPtr(memory, 136 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_Field_set_serverDelegate));
                Marshal.WriteIntPtr(memory, 137 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_Property_get_createdTokenNameDelegate));
                Marshal.WriteIntPtr(memory, 138 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_Property_get_NativeImplementationDelegate));
                Marshal.WriteIntPtr(memory, 139 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_Property_get_selectedExistingTokenIndexDelegate));
                Marshal.WriteIntPtr(memory, 140 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_Property_get_specifiedTokenDelegate));
                Marshal.WriteIntPtr(memory, 141 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_Property_get_tokenSourceDelegate));
                Marshal.WriteIntPtr(memory, 142 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_Property_set_createdTokenNameDelegate));
                Marshal.WriteIntPtr(memory, 143 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_Property_set_selectedExistingTokenIndexDelegate));
                Marshal.WriteIntPtr(memory, 144 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_Property_set_specifiedTokenDelegate));
                Marshal.WriteIntPtr(memory, 145 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_SelectIonTokenWindow_Property_set_tokenSourceDelegate));
                Marshal.WriteIntPtr(memory, 146 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_TokenTroubleshootingDetails_Property_get_allowsAccessToAssetDelegate));
                Marshal.WriteIntPtr(memory, 147 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_TokenTroubleshootingDetails_Property_get_associatedWithUserAccountDelegate));
                Marshal.WriteIntPtr(memory, 148 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_TokenTroubleshootingDetails_Property_get_isValidDelegate));
                Marshal.WriteIntPtr(memory, 149 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_TokenTroubleshootingDetails_Property_get_loadedDelegate));
                Marshal.WriteIntPtr(memory, 150 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_TokenTroubleshootingDetails_Property_get_tokenDelegate));
                Marshal.WriteIntPtr(memory, 151 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_TokenTroubleshootingDetails_Property_set_allowsAccessToAssetDelegate));
                Marshal.WriteIntPtr(memory, 152 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_TokenTroubleshootingDetails_Property_set_associatedWithUserAccountDelegate));
                Marshal.WriteIntPtr(memory, 153 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_TokenTroubleshootingDetails_Property_set_isValidDelegate));
                Marshal.WriteIntPtr(memory, 154 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_TokenTroubleshootingDetails_Property_set_loadedDelegate));
                Marshal.WriteIntPtr(memory, 155 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_TokenTroubleshootingDetails_Property_set_tokenDelegate));
                Marshal.WriteIntPtr(memory, 156 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(Reinterop_ObjectHandleUtility_CallCopyHandle_Lk0gUmdC13dRVZ_MAT71egDelegate));
                Marshal.WriteIntPtr(memory, 157 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(Reinterop_ObjectHandleUtility_CallCreateHandle_vjOnn8y5DjvqKs3467vAJQDelegate));
                Marshal.WriteIntPtr(memory, 158 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(Reinterop_ObjectHandleUtility_CallFreeHandle_Lk0gUmdC13dRVZ_MAT71egDelegate));
                Marshal.WriteIntPtr(memory, 159 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Action_CallInvoke_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 160 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Action_Callop_Equality__iYzpyUo7S__gDd8L5jFzrgDelegate));
                Marshal.WriteIntPtr(memory, 161 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Action_Callop_Equality_a0RmOPC1vpOfulhhfnafBADelegate));
                Marshal.WriteIntPtr(memory, 162 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Action_Callop_Inequality__iYzpyUo7S__gDd8L5jFzrgDelegate));
                Marshal.WriteIntPtr(memory, 163 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Action_Callop_Inequality_a0RmOPC1vpOfulhhfnafBADelegate));
                Marshal.WriteIntPtr(memory, 164 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Action_CombineDelegatesDelegate));
                Marshal.WriteIntPtr(memory, 165 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Action_CreateDelegateDelegate));
                Marshal.WriteIntPtr(memory, 166 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Action_RemoveDelegateDelegate));
                Marshal.WriteIntPtr(memory, 167 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_ActionA2lFbwI_1jdffaYu1u_OZg_CallInvoke_GZtSECpzDV__dvLP8ujKEdADelegate));
                Marshal.WriteIntPtr(memory, 168 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_ActionA2lFbwI_1jdffaYu1u_OZg_Callop_Equality__iYzpyUo7S__gDd8L5jFzrgDelegate));
                Marshal.WriteIntPtr(memory, 169 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_ActionA2lFbwI_1jdffaYu1u_OZg_Callop_Equality_a0RmOPC1vpOfulhhfnafBADelegate));
                Marshal.WriteIntPtr(memory, 170 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_ActionA2lFbwI_1jdffaYu1u_OZg_Callop_Inequality__iYzpyUo7S__gDd8L5jFzrgDelegate));
                Marshal.WriteIntPtr(memory, 171 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_ActionA2lFbwI_1jdffaYu1u_OZg_Callop_Inequality_a0RmOPC1vpOfulhhfnafBADelegate));
                Marshal.WriteIntPtr(memory, 172 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_ActionA2lFbwI_1jdffaYu1u_OZg_CombineDelegatesDelegate));
                Marshal.WriteIntPtr(memory, 173 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_ActionA2lFbwI_1jdffaYu1u_OZg_CreateDelegateDelegate));
                Marshal.WriteIntPtr(memory, 174 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_ActionA2lFbwI_1jdffaYu1u_OZg_RemoveDelegateDelegate));
                Marshal.WriteIntPtr(memory, 175 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Array_Property_get_LengthDelegate));
                Marshal.WriteIntPtr(memory, 176 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Array10EgxpGTzCG1YTfWqwgLniw_Constructor_SizeDelegate));
                Marshal.WriteIntPtr(memory, 177 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Array10EgxpGTzCG1YTfWqwgLniw_Property_get_ItemDelegate));
                Marshal.WriteIntPtr(memory, 178 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Array10EgxpGTzCG1YTfWqwgLniw_Property_get_LengthDelegate));
                Marshal.WriteIntPtr(memory, 179 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Array10EgxpGTzCG1YTfWqwgLniw_SetItemDelegate));
                Marshal.WriteIntPtr(memory, 180 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Array1BAtcoWNWVoAVplmna6OgsQ_Constructor_SizeDelegate));
                Marshal.WriteIntPtr(memory, 181 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Array1BAtcoWNWVoAVplmna6OgsQ_Property_get_ItemDelegate));
                Marshal.WriteIntPtr(memory, 182 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Array1BAtcoWNWVoAVplmna6OgsQ_Property_get_LengthDelegate));
                Marshal.WriteIntPtr(memory, 183 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Array1BAtcoWNWVoAVplmna6OgsQ_SetItemDelegate));
                Marshal.WriteIntPtr(memory, 184 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Array1H1UZCBm__Pf6NnqpE7xQ8NQ_Constructor_SizeDelegate));
                Marshal.WriteIntPtr(memory, 185 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Array1H1UZCBm__Pf6NnqpE7xQ8NQ_Property_get_ItemDelegate));
                Marshal.WriteIntPtr(memory, 186 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Array1H1UZCBm__Pf6NnqpE7xQ8NQ_Property_get_LengthDelegate));
                Marshal.WriteIntPtr(memory, 187 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(CesiumForUnity_Array1H1UZCBm__Pf6NnqpE7xQ8NQ_SetItemDelegate));
                Marshal.WriteIntPtr(memory, 188 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Array1z79ECk55IqLfMIqXBYg_8w_Constructor_SizeDelegate));
                Marshal.WriteIntPtr(memory, 189 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Array1z79ECk55IqLfMIqXBYg_8w_Property_get_LengthDelegate));
                Marshal.WriteIntPtr(memory, 190 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Array1z79ECk55IqLfMIqXBYg_8w_SetItemDelegate));
                Marshal.WriteIntPtr(memory, 191 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Collections_Generic_Dictionary5Hx6c0Eu2sl__zevLSSpjKA_CallGetEnumerator_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 192 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Collections_Generic_Enumerator1B2M2Y8AsgTpgAmY7PhCfg_CallMoveNext_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 193 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Collections_Generic_Enumerator1B2M2Y8AsgTpgAmY7PhCfg_Property_get_CurrentDelegate));
                Marshal.WriteIntPtr(memory, 194 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Collections_Generic_KeyValuePair5Hx6c0Eu2sl__zevLSSpjKA_Property_get_KeyDelegate));
                Marshal.WriteIntPtr(memory, 195 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Collections_Generic_KeyValuePair5Hx6c0Eu2sl__zevLSSpjKA_Property_get_ValueDelegate));
                Marshal.WriteIntPtr(memory, 196 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Collections_Generic_ListBSSRPFX2rxvf__GnQ_i__RxA_CallAdd_nq8TJwFX_ptyb2rCV3CGswDelegate));
                Marshal.WriteIntPtr(memory, 197 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Collections_Generic_ListBSSRPFX2rxvf__GnQ_i__RxA_Construct_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 198 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Collections_Generic_List5eSlqDLksZG1Mz9C9wH0GQ_CallAdd_LRSjiXmrvb5pgfbcZ_Nv7wDelegate));
                Marshal.WriteIntPtr(memory, 199 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Collections_Generic_List5eSlqDLksZG1Mz9C9wH0GQ_CallClear_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 200 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Delegate_Callop_Equality_a0RmOPC1vpOfulhhfnafBADelegate));
                Marshal.WriteIntPtr(memory, 201 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Delegate_Callop_Inequality_a0RmOPC1vpOfulhhfnafBADelegate));
                Marshal.WriteIntPtr(memory, 202 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Environment_Property_get_OSVersionDelegate));
                Marshal.WriteIntPtr(memory, 203 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_MulticastDelegate_Callop_Equality__iYzpyUo7S__gDd8L5jFzrgDelegate));
                Marshal.WriteIntPtr(memory, 204 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_MulticastDelegate_Callop_Equality_a0RmOPC1vpOfulhhfnafBADelegate));
                Marshal.WriteIntPtr(memory, 205 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_MulticastDelegate_Callop_Inequality__iYzpyUo7S__gDd8L5jFzrgDelegate));
                Marshal.WriteIntPtr(memory, 206 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_MulticastDelegate_Callop_Inequality_a0RmOPC1vpOfulhhfnafBADelegate));
                Marshal.WriteIntPtr(memory, 207 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Object_Construct_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 208 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_OperatingSystem_Property_get_VersionStringDelegate));
                Marshal.WriteIntPtr(memory, 209 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Runtime_InteropServices_Marshal_CallFreeCoTaskMem_eF5IwSJe_WM3IuDxcegQFgDelegate));
                Marshal.WriteIntPtr(memory, 210 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Runtime_InteropServices_Marshal_CallStringToCoTaskMemUTF8_ga80EVd9gqZ4YlhSP8iRzgDelegate));
                Marshal.WriteIntPtr(memory, 211 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_String_CallConcat_OM9SoWVFMTHXvbepMyUchwDelegate));
                Marshal.WriteIntPtr(memory, 212 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_String_CallConcat_yq7nlytzIFp8a79slfH_mwDelegate));
                Marshal.WriteIntPtr(memory, 213 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_String_CallContains_GImL1A5rlEQAx14EidO2oADelegate));
                Marshal.WriteIntPtr(memory, 214 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_String_CallEquals_46DLRq__QwpwCx8Uf20Cl7ADelegate));
                Marshal.WriteIntPtr(memory, 215 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_String_CallIsNullOrEmpty_ZOWEGUlscki07yVzH4i4wwDelegate));
                Marshal.WriteIntPtr(memory, 216 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_String_Callop_Equality_46DLRq__QwpwCx8Uf20Cl7ADelegate));
                Marshal.WriteIntPtr(memory, 217 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_String_Callop_Inequality_46DLRq__QwpwCx8Uf20Cl7ADelegate));
                Marshal.WriteIntPtr(memory, 218 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_String_Property_get_LengthDelegate));
                Marshal.WriteIntPtr(memory, 219 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Text_Encoding_CallGetString_J_gIxYGOW0ecDuybXJZsCwDelegate));
                Marshal.WriteIntPtr(memory, 220 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Text_Encoding_Property_get_UTF8Delegate));
                Marshal.WriteIntPtr(memory, 221 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(System_Threading_Tasks_Task_CallRun_uG3jiSYLEmrwe0pJoPtxoADelegate));
                Marshal.WriteIntPtr(memory, 222 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(Unity_Collections_LowLevel_Unsafe_NativeArrayUnsafeUtility_CallGetUnsafeBufferPointerWithoutChecks_QIjAavb5O6M1Tim2Rs2ohQDelegate));
                Marshal.WriteIntPtr(memory, 223 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(Unity_Collections_NativeArrayz79ECk55IqLfMIqXBYg_8w_Callop_Equality___ZFbUbDYmnqRGnwegIjKPwDelegate));
                Marshal.WriteIntPtr(memory, 224 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(Unity_Collections_NativeArrayz79ECk55IqLfMIqXBYg_8w_Callop_Inequality___ZFbUbDYmnqRGnwegIjKPwDelegate));
                Marshal.WriteIntPtr(memory, 225 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(Unity_Collections_NativeArrayz79ECk55IqLfMIqXBYg_8w_Construct_fyLz0cEPCtnsPNSt__omZwQDelegate));
                Marshal.WriteIntPtr(memory, 226 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_EditorApplication_CallExecuteMenuItem__mTAWffFaNJNxtE3VLYhxwDelegate));
                Marshal.WriteIntPtr(memory, 227 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_EditorPrefs_CallDeleteKey_4Oa4KGDR__vvaosUsC29xLgDelegate));
                Marshal.WriteIntPtr(memory, 228 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_EditorPrefs_CallGetString_4Oa4KGDR__vvaosUsC29xLgDelegate));
                Marshal.WriteIntPtr(memory, 229 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_EditorPrefs_CallHasKey_4Oa4KGDR__vvaosUsC29xLgDelegate));
                Marshal.WriteIntPtr(memory, 230 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_EditorPrefs_CallSetString_eMSjpsyKrCDpoy__674QaewDelegate));
                Marshal.WriteIntPtr(memory, 231 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_EditorUtility_CallSetDirty_byPIQUdz9akDU2__zoHd1tgDelegate));
                Marshal.WriteIntPtr(memory, 232 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_EditorWindow_CallClose_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 233 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_EditorWindow_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 234 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_EditorWindow_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 235 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_MultiColumnHeader_CallIsSortedAscending_ZiJhFqE0LPDoV__RgQlNVpQDelegate));
                Marshal.WriteIntPtr(memory, 236 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_MultiColumnHeader_Property_get_sortedColumnIndexDelegate));
                Marshal.WriteIntPtr(memory, 237 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_MultiColumnHeader_Property_set_sortedColumnIndexDelegate));
                Marshal.WriteIntPtr(memory, 238 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_TreeView_CallReload_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 239 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_TreeView_Property_get_multiColumnHeaderDelegate));
                Marshal.WriteIntPtr(memory, 240 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_TreeView_Property_get_searchStringDelegate));
                Marshal.WriteIntPtr(memory, 241 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_TreeView_Property_set_multiColumnHeaderDelegate));
                Marshal.WriteIntPtr(memory, 242 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_TreeView_Property_set_searchStringDelegate));
                Marshal.WriteIntPtr(memory, 243 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_TreeViewItem_Construct_fAkE2H7EjTzReHiM2XHBPADelegate));
                Marshal.WriteIntPtr(memory, 244 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_TreeViewItem_Property_get_idDelegate));
                Marshal.WriteIntPtr(memory, 245 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_TreeViewItem_Property_set_idDelegate));
                Marshal.WriteIntPtr(memory, 246 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_TreeViewState_Construct_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 247 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 248 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 249 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Property_get_instanceDelegate));
                Marshal.WriteIntPtr(memory, 250 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_Selection_Property_get_activeGameObjectDelegate));
                Marshal.WriteIntPtr(memory, 251 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_Selection_Property_set_activeGameObjectDelegate));
                Marshal.WriteIntPtr(memory, 252 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Application_CallOpenURL_i4__FgVIR5VYHO4KBzPBwNQDelegate));
                Marshal.WriteIntPtr(memory, 253 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Application_Property_get_platformDelegate));
                Marshal.WriteIntPtr(memory, 254 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Application_Property_get_productNameDelegate));
                Marshal.WriteIntPtr(memory, 255 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Application_Property_get_temporaryCachePathDelegate));
                Marshal.WriteIntPtr(memory, 256 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Application_Property_get_unityVersionDelegate));
                Marshal.WriteIntPtr(memory, 257 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Application_Property_get_versionDelegate));
                Marshal.WriteIntPtr(memory, 258 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_AsyncOperation_Calladd_completed_89b__Riirtgd1Q5mmRzPojADelegate));
                Marshal.WriteIntPtr(memory, 259 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_AsyncOperation_Callremove_completed_89b__Riirtgd1Q5mmRzPojADelegate));
                Marshal.WriteIntPtr(memory, 260 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Component_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 261 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Component_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 262 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Component_Property_get_gameObjectDelegate));
                Marshal.WriteIntPtr(memory, 263 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Debug_CallLog_FA05wu8x__otZNsgdHTnU9ADelegate));
                Marshal.WriteIntPtr(memory, 264 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Debug_CallLogError_FA05wu8x__otZNsgdHTnU9ADelegate));
                Marshal.WriteIntPtr(memory, 265 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Debug_CallLogWarning_FA05wu8x__otZNsgdHTnU9ADelegate));
                Marshal.WriteIntPtr(memory, 266 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GameObject_CallAddComponent_0EgxpGTzCG1YTfWqwgLniwDelegate));
                Marshal.WriteIntPtr(memory, 267 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GameObject_CallAddComponent_BAtcoWNWVoAVplmna6OgsQDelegate));
                Marshal.WriteIntPtr(memory, 268 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GameObject_CallGetComponent_0EgxpGTzCG1YTfWqwgLniwDelegate));
                Marshal.WriteIntPtr(memory, 269 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GameObject_CallGetComponent_BAtcoWNWVoAVplmna6OgsQDelegate));
                Marshal.WriteIntPtr(memory, 270 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GameObject_CallGetComponents_BAtcoWNWVoAVplmna6OgsQDelegate));
                Marshal.WriteIntPtr(memory, 271 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GameObject_CallGetComponents_H1UZCBm__Pf6NnqpE7xQ8NQDelegate));
                Marshal.WriteIntPtr(memory, 272 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GameObject_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 273 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GameObject_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 274 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GameObject_Construct_wfPSjxsETIcebv8un8PGZwDelegate));
                Marshal.WriteIntPtr(memory, 275 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GUI_CallLabel_iRU7t71QqJzkr4BTYehN9ADelegate));
                Marshal.WriteIntPtr(memory, 276 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_DownloadHandler_CallDispose_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 277 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_CallGet_Y2__l4HVQ8CbSg4jpXDip9ADelegate));
                Marshal.WriteIntPtr(memory, 278 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_CallGetResponseHeader_wfPSjxsETIcebv8un8PGZwDelegate));
                Marshal.WriteIntPtr(memory, 279 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_CallGetResponseHeaders_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 280 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_CallSendWebRequest_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 281 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_CallSetRequestHeader_tEfBle3aSdR47_HxLakNjwDelegate));
                Marshal.WriteIntPtr(memory, 282 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Construct_N5nF6s7__PflIcgtgQgj6DADelegate));
                Marshal.WriteIntPtr(memory, 283 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_get_downloadHandlerDelegate));
                Marshal.WriteIntPtr(memory, 284 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_get_errorDelegate));
                Marshal.WriteIntPtr(memory, 285 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_get_isDoneDelegate));
                Marshal.WriteIntPtr(memory, 286 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_get_methodDelegate));
                Marshal.WriteIntPtr(memory, 287 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_get_responseCodeDelegate));
                Marshal.WriteIntPtr(memory, 288 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_get_resultDelegate));
                Marshal.WriteIntPtr(memory, 289 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_get_urlDelegate));
                Marshal.WriteIntPtr(memory, 290 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_set_downloadHandlerDelegate));
                Marshal.WriteIntPtr(memory, 291 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_set_methodDelegate));
                Marshal.WriteIntPtr(memory, 292 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_set_urlDelegate));
                Marshal.WriteIntPtr(memory, 293 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequestAsyncOperation_Calladd_completed_89b__Riirtgd1Q5mmRzPojADelegate));
                Marshal.WriteIntPtr(memory, 294 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequestAsyncOperation_Callremove_completed_89b__Riirtgd1Q5mmRzPojADelegate));
                Marshal.WriteIntPtr(memory, 295 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UploadHandlerRaw_Construct_j9VUe_obWzqxHm0yKnVCmgDelegate));
                Marshal.WriteIntPtr(memory, 296 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UploadHandlerRaw_Construct_Wn8TTeG3Q36ufSfvO3m1sgDelegate));
                Marshal.WriteIntPtr(memory, 297 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Object_CallDestroyImmediate_c5oFMRh3nzKMIo8On83YBgDelegate));
                Marshal.WriteIntPtr(memory, 298 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Object_CallDestroyImmediate_x7aQMuJcEpatC9689ghI4ADelegate));
                Marshal.WriteIntPtr(memory, 299 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Object_CallFindObjectsOfType_0EgxpGTzCG1YTfWqwgLniwDelegate));
                Marshal.WriteIntPtr(memory, 300 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Object_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 301 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Object_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 302 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Rect_Construct_SWzoP__nNh7g2zNwjI5mUvQDelegate));
            }
        }
        ...
        static ReinteropInitializer()
        {
            unsafe
            {
                IntPtr memory = Marshal.AllocHGlobal(sizeof(IntPtr) * 303);
                AddFunctionPointers(memory);
                byte success = initializeReinterop(8582506295102039175UL, memory, 303);
                if (success == 0)
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_Cesium3DTileset_Property_get_ionServerType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_Cesium3DTileset_Property_get_ionServerType CesiumForUnity_Cesium3DTileset_Property_get_ionServerDelegate = new CesiumForUnity_Cesium3DTileset_Property_get_ionServerType(CesiumForUnity_Cesium3DTileset_Property_get_ionServer);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_Cesium3DTileset_Property_get_ionServerType))]
        private static unsafe System.IntPtr CesiumForUnity_Cesium3DTileset_Property_get_ionServer(System.IntPtr thiz)
        {
            
            var result = ((CesiumForUnity.Cesium3DTileset)Reinterop.ObjectHandleUtility.GetObjectFromHandle(thiz)!).ionServer;
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_Cesium3DTileset_Property_set_ionServerType(System.IntPtr thiz, System.IntPtr value);
        private static unsafe readonly CesiumForUnity_Cesium3DTileset_Property_set_ionServerType CesiumForUnity_Cesium3DTileset_Property_set_ionServerDelegate = new CesiumForUnity_Cesium3DTileset_Property_set_ionServerType(CesiumForUnity_Cesium3DTileset_Property_set_ionServer);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_Cesium3DTileset_Property_set_ionServerType))]
        private static unsafe void CesiumForUnity_Cesium3DTileset_Property_set_ionServer(System.IntPtr thiz, System.IntPtr value)
        {
            ((CesiumForUnity.Cesium3DTileset)Reinterop.ObjectHandleUtility.GetObjectFromHandle(thiz)!).ionServer = (CesiumForUnity.CesiumIonServer)Reinterop.ObjectHandleUtility.GetObjectFromHandle(value)!;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_CesiumIonAsset_Property_get_overlayType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_CesiumIonAsset_Property_get_overlayType CesiumForUnity_CesiumIonAsset_Property_get_overlayDelegate = new CesiumForUnity_CesiumIonAsset_Property_get_overlayType(CesiumForUnity_CesiumIonAsset_Property_get_overlay);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonAsset_Property_get_overlayType))]
        private static unsafe System.IntPtr CesiumForUnity_CesiumIonAsset_Property_get_overlay(System.IntPtr thiz)
        {
            
            var result = ((CesiumForUnity.CesiumIonAsset)Reinterop.ObjectHandleUtility.GetObjectFromHandle(thiz)!).overlay;
            
            return Reinterop.ObjectHandleUtility.CreateHandle(result);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_CesiumIonAsset_Property_get_tilesetType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_CesiumIonAsset_Property_get_tilesetType CesiumForUnity_CesiumIonAsset_Property_get_tilesetDelegate = new CesiumForUnity_CesiumIonAsset_Property_get_tilesetType(CesiumForUnity_CesiumIonAsset_Property_get_tileset);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonAsset_Property_get_tilesetType))]
        private static unsafe System.IntPtr CesiumForUnity_CesiumIonAsset_Property_get_tileset(System.IntPtr thiz)
        {
            
            var result = ((CesiumForUnity.CesiumIonAsset)Reinterop.ObjectHandleUtility.GetObjectFromHandle(thiz)!).tileset;
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_CesiumIonRasterOverlay_Property_get_ionServerType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_CesiumIonRasterOverlay_Property_get_ionServerType CesiumForUnity_CesiumIonRasterOverlay_Property_get_ionServerDelegate = new CesiumForUnity_CesiumIonRasterOverlay_Property_get_ionServerType(CesiumForUnity_CesiumIonRasterOverlay_Property_get_ionServer);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonRasterOverlay_Property_get_ionServerType))]
        private static unsafe System.IntPtr CesiumForUnity_CesiumIonRasterOverlay_Property_get_ionServer(System.IntPtr thiz)
        {
            
            var result = ((CesiumForUnity.CesiumIonRasterOverlay)Reinterop.ObjectHandleUtility.GetObjectFromHandle(thiz)!).ionServer;
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_CesiumIonRasterOverlay_Property_set_ionServerType(System.IntPtr thiz, System.IntPtr value);
        private static unsafe readonly CesiumForUnity_CesiumIonRasterOverlay_Property_set_ionServerType CesiumForUnity_CesiumIonRasterOverlay_Property_set_ionServerDelegate = new CesiumForUnity_CesiumIonRasterOverlay_Property_set_ionServerType(CesiumForUnity_CesiumIonRasterOverlay_Property_set_ionServer);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonRasterOverlay_Property_set_ionServerType))]
        private static unsafe void CesiumForUnity_CesiumIonRasterOverlay_Property_set_ionServer(System.IntPtr thiz, System.IntPtr value)
        {
            ((CesiumForUnity.CesiumIonRasterOverlay)Reinterop.ObjectHandleUtility.GetObjectFromHandle(thiz)!).ionServer = (CesiumForUnity.CesiumIonServer)Reinterop.ObjectHandleUtility.GetObjectFromHandle(value)!;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate byte CesiumForUnity_CesiumIonServer_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgType(System.IntPtr x, System.IntPtr y);
        private static unsafe readonly CesiumForUnity_CesiumIonServer_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgType CesiumForUnity_CesiumIonServer_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate = new CesiumForUnity_CesiumIonServer_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgType(CesiumForUnity_CesiumIonServer_Callop_Equality_5bi2N6jTkaYVhpHPRxL2Wg);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServer_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgType))]
        private static unsafe byte CesiumForUnity_CesiumIonServer_Callop_Equality_5bi2N6jTkaYVhpHPRxL2Wg(System.IntPtr x, System.IntPtr y)
        {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate byte CesiumForUnity_CesiumIonServer_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgType(System.IntPtr x, System.IntPtr y);
        private static unsafe readonly CesiumForUnity_CesiumIonServer_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgType CesiumForUnity_CesiumIonServer_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate = new CesiumForUnity_CesiumIonServer_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgType(CesiumForUnity_CesiumIonServer_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2Wg);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServer_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgType))]
        private static unsafe byte CesiumForUnity_CesiumIonServer_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2Wg(System.IntPtr x, System.IntPtr y)
        {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_CesiumIonServer_Field_get_apiUrlType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_CesiumIonServer_Field_get_apiUrlType CesiumForUnity_CesiumIonServer_Field_get_apiUrlDelegate = new CesiumForUnity_CesiumIonServer_Field_get_apiUrlType(CesiumForUnity_CesiumIonServer_Field_get_apiUrl);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServer_Field_get_apiUrlType))]
        private static unsafe System.IntPtr CesiumForUnity_CesiumIonServer_Field_get_apiUrl(System.IntPtr thiz)
        {
            var result = ((CesiumForUnity.CesiumIonServer)ObjectHandleUtility.GetObjectFromHandle(thiz)!).apiUrl;
          return Reinterop.ObjectHandleUtility.CreateHandle(result);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_CesiumIonServer_Field_get_defaultIonAccessTokenType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_CesiumIonServer_Field_get_defaultIonAccessTokenType CesiumForUnity_CesiumIonServer_Field_get_defaultIonAccessTokenDelegate = new CesiumForUnity_CesiumIonServer_Field_get_defaultIonAccessTokenType(CesiumForUnity_CesiumIonServer_Field_get_defaultIonAccessToken);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServer_Field_get_defaultIonAccessTokenType))]
        private static unsafe System.IntPtr CesiumForUnity_CesiumIonServer_Field_get_defaultIonAccessToken(System.IntPtr thiz)
        {
            var result = ((CesiumForUnity.CesiumIonServer)ObjectHandleUtility.GetObjectFromHandle(thiz)!).defaultIonAccessToken;
          return Reinterop.ObjectHandleUtility.CreateHandle(result);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_CesiumIonServer_Field_get_defaultIonAccessTokenIdType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_CesiumIonServer_Field_get_defaultIonAccessTokenIdType CesiumForUnity_CesiumIonServer_Field_get_defaultIonAccessTokenIdDelegate = new CesiumForUnity_CesiumIonServer_Field_get_defaultIonAccessTokenIdType(CesiumForUnity_CesiumIonServer_Field_get_defaultIonAccessTokenId);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServer_Field_get_defaultIonAccessTokenIdType))]
        private static unsafe System.IntPtr CesiumForUnity_CesiumIonServer_Field_get_defaultIonAccessTokenId(System.IntPtr thiz)
        {
            var result = ((CesiumForUnity.CesiumIonServer)ObjectHandleUtility.GetObjectFromHandle(thiz)!).defaultIonAccessTokenId;
          return Reinterop.ObjectHandleUtility.CreateHandle(result);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate long CesiumForUnity_CesiumIonServer_Field_get_oauth2ApplicationIDType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_CesiumIonServer_Field_get_oauth2ApplicationIDType CesiumForUnity_CesiumIonServer_Field_get_oauth2ApplicationIDDelegate = new CesiumForUnity_CesiumIonServer_Field_get_oauth2ApplicationIDType(CesiumForUnity_CesiumIonServer_Field_get_oauth2ApplicationID);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServer_Field_get_oauth2ApplicationIDType))]
        private static unsafe long CesiumForUnity_CesiumIonServer_Field_get_oauth2ApplicationID(System.IntPtr thiz)
        {
            var result = ((CesiumForUnity.CesiumIonServer)ObjectHandleUtility.GetObjectFromHandle(thiz)!).oauth2ApplicationID;
          return result;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_CesiumIonServer_Field_get_serverUrlType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_CesiumIonServer_Field_get_serverUrlType CesiumForUnity_CesiumIonServer_Field_get_serverUrlDelegate = new CesiumForUnity_CesiumIonServer_Field_get_serverUrlType(CesiumForUnity_CesiumIonServer_Field_get_serverUrl);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServer_Field_get_serverUrlType))]
        private static unsafe System.IntPtr CesiumForUnity_CesiumIonServer_Field_get_serverUrl(System.IntPtr thiz)
        {
            var result = ((CesiumForUnity.CesiumIonServer)ObjectHandleUtility.GetObjectFromHandle(thiz)!).serverUrl;
          return Reinterop.ObjectHandleUtility.CreateHandle(result);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_CesiumIonServer_Field_set_apiUrlType(System.IntPtr thiz, System.IntPtr value);
        private static unsafe readonly CesiumForUnity_CesiumIonServer_Field_set_apiUrlType CesiumForUnity_CesiumIonServer_Field_set_apiUrlDelegate = new CesiumForUnity_CesiumIonServer_Field_set_apiUrlType(CesiumForUnity_CesiumIonServer_Field_set_apiUrl);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServer_Field_set_apiUrlType))]
        private static unsafe void CesiumForUnity_CesiumIonServer_Field_set_apiUrl(System.IntPtr thiz, System.IntPtr value)
        {
            ((CesiumForUnity.CesiumIonServer)ObjectHandleUtility.GetObjectFromHandle(thiz)!).apiUrl = (string)Reinterop.ObjectHandleUtility.GetObjectFromHandle(value)!;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_CesiumIonServer_Field_set_defaultIonAccessTokenType(System.IntPtr thiz, System.IntPtr value);
        private static unsafe readonly CesiumForUnity_CesiumIonServer_Field_set_defaultIonAccessTokenType CesiumForUnity_CesiumIonServer_Field_set_defaultIonAccessTokenDelegate = new CesiumForUnity_CesiumIonServer_Field_set_defaultIonAccessTokenType(CesiumForUnity_CesiumIonServer_Field_set_defaultIonAccessToken);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServer_Field_set_defaultIonAccessTokenType))]
        private static unsafe void CesiumForUnity_CesiumIonServer_Field_set_defaultIonAccessToken(System.IntPtr thiz, System.IntPtr value)
        {
            ((CesiumForUnity.CesiumIonServer)ObjectHandleUtility.GetObjectFromHandle(thiz)!).defaultIonAccessToken = (string)Reinterop.ObjectHandleUtility.GetObjectFromHandle(value)!;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_CesiumIonServer_Field_set_defaultIonAccessTokenIdType(System.IntPtr thiz, System.IntPtr value);
        private static unsafe readonly CesiumForUnity_CesiumIonServer_Field_set_defaultIonAccessTokenIdType CesiumForUnity_CesiumIonServer_Field_set_defaultIonAccessTokenIdDelegate = new CesiumForUnity_CesiumIonServer_Field_set_defaultIonAccessTokenIdType(CesiumForUnity_CesiumIonServer_Field_set_defaultIonAccessTokenId);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServer_Field_set_defaultIonAccessTokenIdType))]
        private static unsafe void CesiumForUnity_CesiumIonServer_Field_set_defaultIonAccessTokenId(System.IntPtr thiz, System.IntPtr value)
        {
            ((CesiumForUnity.CesiumIonServer)ObjectHandleUtility.GetObjectFromHandle(thiz)!).defaultIonAccessTokenId = (string)Reinterop.ObjectHandleUtility.GetObjectFromHandle(value)!;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_CesiumIonServer_Field_set_oauth2ApplicationIDType(System.IntPtr thiz, long value);
        private static unsafe readonly CesiumForUnity_CesiumIonServer_Field_set_oauth2ApplicationIDType CesiumForUnity_CesiumIonServer_Field_set_oauth2ApplicationIDDelegate = new CesiumForUnity_CesiumIonServer_Field_set_oauth2ApplicationIDType(CesiumForUnity_CesiumIonServer_Field_set_oauth2ApplicationID);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServer_Field_set_oauth2ApplicationIDType))]
        private static unsafe void CesiumForUnity_CesiumIonServer_Field_set_oauth2ApplicationID(System.IntPtr thiz, long value)
        {
            ((CesiumForUnity.CesiumIonServer)ObjectHandleUtility.GetObjectFromHandle(thiz)!).oauth2ApplicationID = value;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_CesiumIonServer_Field_set_serverUrlType(System.IntPtr thiz, System.IntPtr value);
        private static unsafe readonly CesiumForUnity_CesiumIonServer_Field_set_serverUrlType CesiumForUnity_CesiumIonServer_Field_set_serverUrlDelegate = new CesiumForUnity_CesiumIonServer_Field_set_serverUrlType(CesiumForUnity_CesiumIonServer_Field_set_serverUrl);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServer_Field_set_serverUrlType))]
        private static unsafe void CesiumForUnity_CesiumIonServer_Field_set_serverUrl(System.IntPtr thiz, System.IntPtr value)
        {
            ((CesiumForUnity.CesiumIonServer)ObjectHandleUtility.GetObjectFromHandle(thiz)!).serverUrl = (string)Reinterop.ObjectHandleUtility.GetObjectFromHandle(value)!;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_CesiumIonServerManager_CallGetSession_ouKG7YNdV4bUJcBV0W3dBAType(System.IntPtr thiz, System.IntPtr server);
        private static unsafe readonly CesiumForUnity_CesiumIonServerManager_CallGetSession_ouKG7YNdV4bUJcBV0W3dBAType CesiumForUnity_CesiumIonServerManager_CallGetSession_ouKG7YNdV4bUJcBV0W3dBADelegate = new CesiumForUnity_CesiumIonServerManager_CallGetSession_ouKG7YNdV4bUJcBV0W3dBAType(CesiumForUnity_CesiumIonServerManager_CallGetSession_ouKG7YNdV4bUJcBV0W3dBA);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServerManager_CallGetSession_ouKG7YNdV4bUJcBV0W3dBAType))]
        private static unsafe System.IntPtr CesiumForUnity_CesiumIonServerManager_CallGetSession_ouKG7YNdV4bUJcBV0W3dBA(System.IntPtr thiz, System.IntPtr server)
        {
            
            var result = ((CesiumForUnity.CesiumIonServerManager)Reinterop.ObjectHandleUtility.GetObjectFromHandle(thiz)!).GetSession((CesiumForUnity.CesiumIonServer)Reinterop.ObjectHandleUtility.GetObjectFromHandle(server)!);
            
            return Reinterop.ObjectHandleUtility.CreateHandle(result);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_CesiumIonServerManager_CallGetUserAccessToken_ouKG7YNdV4bUJcBV0W3dBAType(System.IntPtr thiz, System.IntPtr server);
        private static unsafe readonly CesiumForUnity_CesiumIonServerManager_CallGetUserAccessToken_ouKG7YNdV4bUJcBV0W3dBAType CesiumForUnity_CesiumIonServerManager_CallGetUserAccessToken_ouKG7YNdV4bUJcBV0W3dBADelegate = new CesiumForUnity_CesiumIonServerManager_CallGetUserAccessToken_ouKG7YNdV4bUJcBV0W3dBAType(CesiumForUnity_CesiumIonServerManager_CallGetUserAccessToken_ouKG7YNdV4bUJcBV0W3dBA);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServerManager_CallGetUserAccessToken_ouKG7YNdV4bUJcBV0W3dBAType))]
        private static unsafe System.IntPtr CesiumForUnity_CesiumIonServerManager_CallGetUserAccessToken_ouKG7YNdV4bUJcBV0W3dBA(System.IntPtr thiz, System.IntPtr server)
        {
            
            var result = ((CesiumForUnity.CesiumIonServerManager)Reinterop.ObjectHandleUtility.GetObjectFromHandle(thiz)!).GetUserAccessToken((CesiumForUnity.CesiumIonServer)Reinterop.ObjectHandleUtility.GetObjectFromHandle(server)!);
            
            return Reinterop.ObjectHandleUtility.CreateHandle(result);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate byte CesiumForUnity_CesiumIonServerManager_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgType(System.IntPtr x, System.IntPtr y);
        private static unsafe readonly CesiumForUnity_CesiumIonServerManager_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgType CesiumForUnity_CesiumIonServerManager_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate = new CesiumForUnity_CesiumIonServerManager_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgType(CesiumForUnity_CesiumIonServerManager_Callop_Equality_5bi2N6jTkaYVhpHPRxL2Wg);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServerManager_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgType))]
        private static unsafe byte CesiumForUnity_CesiumIonServerManager_Callop_Equality_5bi2N6jTkaYVhpHPRxL2Wg(System.IntPtr x, System.IntPtr y)
        {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate byte CesiumForUnity_CesiumIonServerManager_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgType(System.IntPtr x, System.IntPtr y);
        private static unsafe readonly CesiumForUnity_CesiumIonServerManager_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgType CesiumForUnity_CesiumIonServerManager_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate = new CesiumForUnity_CesiumIonServerManager_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgType(CesiumForUnity_CesiumIonServerManager_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2Wg);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServerManager_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgType))]
        private static unsafe byte CesiumForUnity_CesiumIonServerManager_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2Wg(System.IntPtr x, System.IntPtr y)
        {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_CesiumIonServerManager_CallSetUserAccessToken_i1OZfOwTwhgNuaqLRy9vZQType(System.IntPtr thiz, System.IntPtr server, System.IntPtr token);
        private static unsafe readonly CesiumForUnity_CesiumIonServerManager_CallSetUserAccessToken_i1OZfOwTwhgNuaqLRy9vZQType CesiumForUnity_CesiumIonServerManager_CallSetUserAccessToken_i1OZfOwTwhgNuaqLRy9vZQDelegate = new CesiumForUnity_CesiumIonServerManager_CallSetUserAccessToken_i1OZfOwTwhgNuaqLRy9vZQType(CesiumForUnity_CesiumIonServerManager_CallSetUserAccessToken_i1OZfOwTwhgNuaqLRy9vZQ);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServerManager_CallSetUserAccessToken_i1OZfOwTwhgNuaqLRy9vZQType))]
        private static unsafe void CesiumForUnity_CesiumIonServerManager_CallSetUserAccessToken_i1OZfOwTwhgNuaqLRy9vZQ(System.IntPtr thiz, System.IntPtr server, System.IntPtr token)
        {
            ((CesiumForUnity.CesiumIonServerManager)Reinterop.ObjectHandleUtility.GetObjectFromHandle(thiz)!).SetUserAccessToken((CesiumForUnity.CesiumIonServer)Reinterop.ObjectHandleUtility.GetObjectFromHandle(server)!, (string)Reinterop.ObjectHandleUtility.GetObjectFromHandle(token)!);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_CesiumIonServerManager_Property_get_currentType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_CesiumIonServerManager_Property_get_currentType CesiumForUnity_CesiumIonServerManager_Property_get_currentDelegate = new CesiumForUnity_CesiumIonServerManager_Property_get_currentType(CesiumForUnity_CesiumIonServerManager_Property_get_current);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServerManager_Property_get_currentType))]
        private static unsafe System.IntPtr CesiumForUnity_CesiumIonServerManager_Property_get_current(System.IntPtr thiz)
        {
            
            var result = ((CesiumForUnity.CesiumIonServerManager)Reinterop.ObjectHandleUtility.GetObjectFromHandle(thiz)!).current;
            
            return Reinterop.ObjectHandleUtility.CreateHandle(result);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_CesiumIonServerManager_Property_get_currentSessionType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_CesiumIonServerManager_Property_get_currentSessionType CesiumForUnity_CesiumIonServerManager_Property_get_currentSessionDelegate = new CesiumForUnity_CesiumIonServerManager_Property_get_currentSessionType(CesiumForUnity_CesiumIonServerManager_Property_get_currentSession);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServerManager_Property_get_currentSessionType))]
        private static unsafe System.IntPtr CesiumForUnity_CesiumIonServerManager_Property_get_currentSession(System.IntPtr thiz)
        {
            
            var result = ((CesiumForUnity.CesiumIonServerManager)Reinterop.ObjectHandleUtility.GetObjectFromHandle(thiz)!).currentSession;
            
            return Reinterop.ObjectHandleUtility.CreateHandle(result);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_CesiumIonServerManager_Property_get_instanceType();
        private static unsafe readonly CesiumForUnity_CesiumIonServerManager_Property_get_instanceType CesiumForUnity_CesiumIonServerManager_Property_get_instanceDelegate = new CesiumForUnity_CesiumIonServerManager_Property_get_instanceType(CesiumForUnity_CesiumIonServerManager_Property_get_instance);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServerManager_Property_get_instanceType))]
        private static unsafe System.IntPtr CesiumForUnity_CesiumIonServerManager_Property_get_instance()
        {
            
            var result = CesiumForUnity.CesiumIonServerManager.instance;
            
            return Reinterop.ObjectHandleUtility.CreateHandle(result);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_CesiumIonServerManager_Property_set_currentType(System.IntPtr thiz, System.IntPtr value);
        private static unsafe readonly CesiumForUnity_CesiumIonServerManager_Property_set_currentType CesiumForUnity_CesiumIonServerManager_Property_set_currentDelegate = new CesiumForUnity_CesiumIonServerManager_Property_set_currentType(CesiumForUnity_CesiumIonServerManager_Property_set_current);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonServerManager_Property_set_currentType))]
        private static unsafe void CesiumForUnity_CesiumIonServerManager_Property_set_current(System.IntPtr thiz, System.IntPtr value)
        {
            ((CesiumForUnity.CesiumIonServerManager)Reinterop.ObjectHandleUtility.GetObjectFromHandle(thiz)!).current = (CesiumForUnity.CesiumIonServer)Reinterop.ObjectHandleUtility.GetObjectFromHandle(value)!;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_CesiumIonSession_CallBroadcastDefaultsUpdate_1B2M2Y8AsgTpgAmY7PhCfgType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_CesiumIonSession_CallBroadcastDefaultsUpdate_1B2M2Y8AsgTpgAmY7PhCfgType CesiumForUnity_CesiumIonSession_CallBroadcastDefaultsUpdate_1B2M2Y8AsgTpgAmY7PhCfgDelegate = new CesiumForUnity_CesiumIonSession_CallBroadcastDefaultsUpdate_1B2M2Y8AsgTpgAmY7PhCfgType(CesiumForUnity_CesiumIonSession_CallBroadcastDefaultsUpdate_1B2M2Y8AsgTpgAmY7PhCfg);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonSession_CallBroadcastDefaultsUpdate_1B2M2Y8AsgTpgAmY7PhCfgType))]
        private static unsafe void CesiumForUnity_CesiumIonSession_CallBroadcastDefaultsUpdate_1B2M2Y8AsgTpgAmY7PhCfg(System.IntPtr thiz)
        {
            ((CesiumForUnity.CesiumIonSession)Reinterop.ObjectHandleUtility.GetObjectFromHandle(thiz)!).BroadcastDefaultsUpdate();
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_CesiumIonSession_CallGetQuickAddItems_1B2M2Y8AsgTpgAmY7PhCfgType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_CesiumIonSession_CallGetQuickAddItems_1B2M2Y8AsgTpgAmY7PhCfgType CesiumForUnity_CesiumIonSession_CallGetQuickAddItems_1B2M2Y8AsgTpgAmY7PhCfgDelegate = new CesiumForUnity_CesiumIonSession_CallGetQuickAddItems_1B2M2Y8AsgTpgAmY7PhCfgType(CesiumForUnity_CesiumIonSession_CallGetQuickAddItems_1B2M2Y8AsgTpgAmY7PhCfg);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonSession_CallGetQuickAddItems_1B2M2Y8AsgTpgAmY7PhCfgType))]
        private static unsafe System.IntPtr CesiumForUnity_CesiumIonSession_CallGetQuickAddItems_1B2M2Y8AsgTpgAmY7PhCfg(System.IntPtr thiz)
        {
            
            var result = ((CesiumForUnity.CesiumIonSession)Reinterop.ObjectHandleUtility.GetObjectFromHandle(thiz)!).GetQuickAddItems();
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_CesiumIonSession_Property_get_serverType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_CesiumIonSession_Property_get_serverType CesiumForUnity_CesiumIonSession_Property_get_serverDelegate = new CesiumForUnity_CesiumIonSession_Property_get_serverType(CesiumForUnity_CesiumIonSession_Property_get_server);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonSession_Property_get_serverType))]
        private static unsafe System.IntPtr CesiumForUnity_CesiumIonSession_Property_get_server(System.IntPtr thiz)
        {
            
            var result = ((CesiumForUnity.CesiumIonSession)Reinterop.ObjectHandleUtility.GetObjectFromHandle(thiz)!).server;
            
            return Reinterop.ObjectHandleUtility.CreateHandle(result);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_CesiumIonSession_Property_set_serverType(System.IntPtr thiz, System.IntPtr value);
        private static unsafe readonly CesiumForUnity_CesiumIonSession_Property_set_serverType CesiumForUnity_CesiumIonSession_Property_set_serverDelegate = new CesiumForUnity_CesiumIonSession_Property_set_serverType(CesiumForUnity_CesiumIonSession_Property_set_server);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumIonSession_Property_set_serverType))]
        private static unsafe void CesiumForUnity_CesiumIonSession_Property_set_server(System.IntPtr thiz, System.IntPtr value)
        {
            ((CesiumForUnity.CesiumIonSession)Reinterop.ObjectHandleUtility.GetObjectFromHandle(thiz)!).server = (CesiumForUnity.CesiumIonServer)Reinterop.ObjectHandleUtility.GetObjectFromHandle(value)!;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate ulong CesiumForUnity_CesiumRuntimeSettings_Property_get_maxItemsType();
        private static unsafe readonly CesiumForUnity_CesiumRuntimeSettings_Property_get_maxItemsType CesiumForUnity_CesiumRuntimeSettings_Property_get_maxItemsDelegate = new CesiumForUnity_CesiumRuntimeSettings_Property_get_maxItemsType(CesiumForUnity_CesiumRuntimeSettings_Property_get_maxItems);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumRuntimeSettings_Property_get_maxItemsType))]
        private static unsafe ulong CesiumForUnity_CesiumRuntimeSettings_Property_get_maxItems()
        {
            
            var result = CesiumForUnity.CesiumRuntimeSettings.maxItems;
            
            return result;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate int CesiumForUnity_CesiumRuntimeSettings_Property_get_requestsPerCachePruneType();
        private static unsafe readonly CesiumForUnity_CesiumRuntimeSettings_Property_get_requestsPerCachePruneType CesiumForUnity_CesiumRuntimeSettings_Property_get_requestsPerCachePruneDelegate = new CesiumForUnity_CesiumRuntimeSettings_Property_get_requestsPerCachePruneType(CesiumForUnity_CesiumRuntimeSettings_Property_get_requestsPerCachePrune);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_CesiumRuntimeSettings_Property_get_requestsPerCachePruneType))]
        private static unsafe int CesiumForUnity_CesiumRuntimeSettings_Property_get_requestsPerCachePrune()
        {
            
            var result = CesiumForUnity.CesiumRuntimeSettings.requestsPerCachePrune;
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_QuickAddItem_Construct_1B2M2Y8AsgTpgAmY7PhCfgType();
        private static unsafe readonly CesiumForUnity_QuickAddItem_Construct_1B2M2Y8AsgTpgAmY7PhCfgType CesiumForUnity_QuickAddItem_Construct_1B2M2Y8AsgTpgAmY7PhCfgDelegate = new CesiumForUnity_QuickAddItem_Construct_1B2M2Y8AsgTpgAmY7PhCfgType(CesiumForUnity_QuickAddItem_Construct_1B2M2Y8AsgTpgAmY7PhCfg);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_QuickAddItem_Construct_1B2M2Y8AsgTpgAmY7PhCfgType))]
        private static unsafe System.IntPtr CesiumForUnity_QuickAddItem_Construct_1B2M2Y8AsgTpgAmY7PhCfg()
        {
            
            var result = new CesiumForUnity.QuickAddItem();
            
            return Reinterop.ObjectHandleUtility.CreateHandle(result);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_QuickAddItem_Construct_MigqS33KRbgyAt6uiJjTGwType(CesiumForUnity.QuickAddItemType type, System.IntPtr name, System.IntPtr tooltip, System.IntPtr tilesetName, long tilesetId, System.IntPtr overlayName, long overlayId);
        private static unsafe readonly CesiumForUnity_QuickAddItem_Construct_MigqS33KRbgyAt6uiJjTGwType CesiumForUnity_QuickAddItem_Construct_MigqS33KRbgyAt6uiJjTGwDelegate = new CesiumForUnity_QuickAddItem_Construct_MigqS33KRbgyAt6uiJjTGwType(CesiumForUnity_QuickAddItem_Construct_MigqS33KRbgyAt6uiJjTGw);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_QuickAddItem_Construct_MigqS33KRbgyAt6uiJjTGwType))]
        private static unsafe System.IntPtr CesiumForUnity_QuickAddItem_Construct_MigqS33KRbgyAt6uiJjTGw(CesiumForUnity.QuickAddItemType type, System.IntPtr name, System.IntPtr tooltip, System.IntPtr tilesetName, long tilesetId, System.IntPtr overlayName, long overlayId)
        {
            
            var result = new CesiumForUnity.QuickAddItem(type, (string)Reinterop.ObjectHandleUtility.GetObjectFromHandle(name)!, (string)Reinterop.ObjectHandleUtility.GetObjectFromHandle(tooltip)!, (string)Reinterop.ObjectHandleUtility.GetObjectFromHandle(tilesetName)!, tilesetId, (string)Reinterop.ObjectHandleUtility.GetObjectFromHandle(overlayName)!, overlayId);
            
            return Reinterop.ObjectHandleUtility.CreateHandle(result);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_QuickAddItem_Field_get_nameType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_QuickAddItem_Field_get_nameType CesiumForUnity_QuickAddItem_Field_get_nameDelegate = new CesiumForUnity_QuickAddItem_Field_get_nameType(CesiumForUnity_QuickAddItem_Field_get_name);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_QuickAddItem_Field_get_nameType))]
        private static unsafe System.IntPtr CesiumForUnity_QuickAddItem_Field_get_name(System.IntPtr thiz)
        {
            var result = ((CesiumForUnity.QuickAddItem)ObjectHandleUtility.GetObjectFromHandle(thiz)!).name;
          return Reinterop.ObjectHandleUtility.CreateHandle(result);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate long CesiumForUnity_QuickAddItem_Field_get_overlayIdType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_QuickAddItem_Field_get_overlayIdType CesiumForUnity_QuickAddItem_Field_get_overlayIdDelegate = new CesiumForUnity_QuickAddItem_Field_get_overlayIdType(CesiumForUnity_QuickAddItem_Field_get_overlayId);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_QuickAddItem_Field_get_overlayIdType))]
        private static unsafe long CesiumForUnity_QuickAddItem_Field_get_overlayId(System.IntPtr thiz)
        {
            var result = ((CesiumForUnity.QuickAddItem)ObjectHandleUtility.GetObjectFromHandle(thiz)!).overlayId;
          return result;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_QuickAddItem_Field_get_overlayNameType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_QuickAddItem_Field_get_overlayNameType CesiumForUnity_QuickAddItem_Field_get_overlayNameDelegate = new CesiumForUnity_QuickAddItem_Field_get_overlayNameType(CesiumForUnity_QuickAddItem_Field_get_overlayName);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_QuickAddItem_Field_get_overlayNameType))]
        private static unsafe System.IntPtr CesiumForUnity_QuickAddItem_Field_get_overlayName(System.IntPtr thiz)
        {
            var result = ((CesiumForUnity.QuickAddItem)ObjectHandleUtility.GetObjectFromHandle(thiz)!).overlayName;
          return Reinterop.ObjectHandleUtility.CreateHandle(result);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate long CesiumForUnity_QuickAddItem_Field_get_tilesetIdType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_QuickAddItem_Field_get_tilesetIdType CesiumForUnity_QuickAddItem_Field_get_tilesetIdDelegate = new CesiumForUnity_QuickAddItem_Field_get_tilesetIdType(CesiumForUnity_QuickAddItem_Field_get_tilesetId);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_QuickAddItem_Field_get_tilesetIdType))]
        private static unsafe long CesiumForUnity_QuickAddItem_Field_get_tilesetId(System.IntPtr thiz)
        {
            var result = ((CesiumForUnity.QuickAddItem)ObjectHandleUtility.GetObjectFromHandle(thiz)!).tilesetId;
          return result;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_QuickAddItem_Field_get_tilesetNameType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_QuickAddItem_Field_get_tilesetNameType CesiumForUnity_QuickAddItem_Field_get_tilesetNameDelegate = new CesiumForUnity_QuickAddItem_Field_get_tilesetNameType(CesiumForUnity_QuickAddItem_Field_get_tilesetName);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_QuickAddItem_Field_get_tilesetNameType))]
        private static unsafe System.IntPtr CesiumForUnity_QuickAddItem_Field_get_tilesetName(System.IntPtr thiz)
        {
            var result = ((CesiumForUnity.QuickAddItem)ObjectHandleUtility.GetObjectFromHandle(thiz)!).tilesetName;
          return Reinterop.ObjectHandleUtility.CreateHandle(result);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_QuickAddItem_Field_get_tooltipType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_QuickAddItem_Field_get_tooltipType CesiumForUnity_QuickAddItem_Field_get_tooltipDelegate = new CesiumForUnity_QuickAddItem_Field_get_tooltipType(CesiumForUnity_QuickAddItem_Field_get_tooltip);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_QuickAddItem_Field_get_tooltipType))]
        private static unsafe System.IntPtr CesiumForUnity_QuickAddItem_Field_get_tooltip(System.IntPtr thiz)
        {
            var result = ((CesiumForUnity.QuickAddItem)ObjectHandleUtility.GetObjectFromHandle(thiz)!).tooltip;
          return Reinterop.ObjectHandleUtility.CreateHandle(result);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate CesiumForUnity.QuickAddItemType CesiumForUnity_QuickAddItem_Field_get_typeType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_QuickAddItem_Field_get_typeType CesiumForUnity_QuickAddItem_Field_get_typeDelegate = new CesiumForUnity_QuickAddItem_Field_get_typeType(CesiumForUnity_QuickAddItem_Field_get_type);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_QuickAddItem_Field_get_typeType))]
        private static unsafe CesiumForUnity.QuickAddItemType CesiumForUnity_QuickAddItem_Field_get_type(System.IntPtr thiz)
        {
            var result = ((CesiumForUnity.QuickAddItem)ObjectHandleUtility.GetObjectFromHandle(thiz)!).type;
          return result;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_QuickAddItem_Field_set_nameType(System.IntPtr thiz, System.IntPtr value);
        private static unsafe readonly CesiumForUnity_QuickAddItem_Field_set_nameType CesiumForUnity_QuickAddItem_Field_set_nameDelegate = new CesiumForUnity_QuickAddItem_Field_set_nameType(CesiumForUnity_QuickAddItem_Field_set_name);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_QuickAddItem_Field_set_nameType))]
        private static unsafe void CesiumForUnity_QuickAddItem_Field_set_name(System.IntPtr thiz, System.IntPtr value)
        {
            ((CesiumForUnity.QuickAddItem)ObjectHandleUtility.GetObjectFromHandle(thiz)!).name = (string)Reinterop.ObjectHandleUtility.GetObjectFromHandle(value)!;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_QuickAddItem_Field_set_overlayIdType(System.IntPtr thiz, long value);
        private static unsafe readonly CesiumForUnity_QuickAddItem_Field_set_overlayIdType CesiumForUnity_QuickAddItem_Field_set_overlayIdDelegate = new CesiumForUnity_QuickAddItem_Field_set_overlayIdType(CesiumForUnity_QuickAddItem_Field_set_overlayId);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_QuickAddItem_Field_set_overlayIdType))]
        private static unsafe void CesiumForUnity_QuickAddItem_Field_set_overlayId(System.IntPtr thiz, long value)
        {
            ((CesiumForUnity.QuickAddItem)ObjectHandleUtility.GetObjectFromHandle(thiz)!).overlayId = value;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_QuickAddItem_Field_set_overlayNameType(System.IntPtr thiz, System.IntPtr value);
        private static unsafe readonly CesiumForUnity_QuickAddItem_Field_set_overlayNameType CesiumForUnity_QuickAddItem_Field_set_overlayNameDelegate = new CesiumForUnity_QuickAddItem_Field_set_overlayNameType(CesiumForUnity_QuickAddItem_Field_set_overlayName);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_QuickAddItem_Field_set_overlayNameType))]
        private static unsafe void CesiumForUnity_QuickAddItem_Field_set_overlayName(System.IntPtr thiz, System.IntPtr value)
        {
            ((CesiumForUnity.QuickAddItem)ObjectHandleUtility.GetObjectFromHandle(thiz)!).overlayName = (string)Reinterop.ObjectHandleUtility.GetObjectFromHandle(value)!;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_QuickAddItem_Field_set_tilesetIdType(System.IntPtr thiz, long value);
        private static unsafe readonly CesiumForUnity_QuickAddItem_Field_set_tilesetIdType CesiumForUnity_QuickAddItem_Field_set_tilesetIdDelegate = new CesiumForUnity_QuickAddItem_Field_set_tilesetIdType(CesiumForUnity_QuickAddItem_Field_set_tilesetId);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_QuickAddItem_Field_set_tilesetIdType))]
        private static unsafe void CesiumForUnity_QuickAddItem_Field_set_tilesetId(System.IntPtr thiz, long value)
        {
            ((CesiumForUnity.QuickAddItem)ObjectHandleUtility.GetObjectFromHandle(thiz)!).tilesetId = value;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_QuickAddItem_Field_set_tilesetNameType(System.IntPtr thiz, System.IntPtr value);
        private static unsafe readonly CesiumForUnity_QuickAddItem_Field_set_tilesetNameType CesiumForUnity_QuickAddItem_Field_set_tilesetNameDelegate = new CesiumForUnity_QuickAddItem_Field_set_tilesetNameType(CesiumForUnity_QuickAddItem_Field_set_tilesetName);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_QuickAddItem_Field_set_tilesetNameType))]
        private static unsafe void CesiumForUnity_QuickAddItem_Field_set_tilesetName(System.IntPtr thiz, System.IntPtr value)
        {
            ((CesiumForUnity.QuickAddItem)ObjectHandleUtility.GetObjectFromHandle(thiz)!).tilesetName = (string)Reinterop.ObjectHandleUtility.GetObjectFromHandle(value)!;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_QuickAddItem_Field_set_tooltipType(System.IntPtr thiz, System.IntPtr value);
        private static unsafe readonly CesiumForUnity_QuickAddItem_Field_set_tooltipType CesiumForUnity_QuickAddItem_Field_set_tooltipDelegate = new CesiumForUnity_QuickAddItem_Field_set_tooltipType(CesiumForUnity_QuickAddItem_Field_set_tooltip);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_QuickAddItem_Field_set_tooltipType))]
        private static unsafe void CesiumForUnity_QuickAddItem_Field_set_tooltip(System.IntPtr thiz, System.IntPtr value)
        {
            ((CesiumForUnity.QuickAddItem)ObjectHandleUtility.GetObjectFromHandle(thiz)!).tooltip = (string)Reinterop.ObjectHandleUtility.GetObjectFromHandle(value)!;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_QuickAddItem_Field_set_typeType(System.IntPtr thiz, CesiumForUnity.QuickAddItemType value);
        private static unsafe readonly CesiumForUnity_QuickAddItem_Field_set_typeType CesiumForUnity_QuickAddItem_Field_set_typeDelegate = new CesiumForUnity_QuickAddItem_Field_set_typeType(CesiumForUnity_QuickAddItem_Field_set_type);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_QuickAddItem_Field_set_typeType))]
        private static unsafe void CesiumForUnity_QuickAddItem_Field_set_type(System.IntPtr thiz, CesiumForUnity.QuickAddItemType value)
        {
            ((CesiumForUnity.QuickAddItem)ObjectHandleUtility.GetObjectFromHandle(thiz)!).type = value;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_SelectIonTokenWindow_CallShowWindow_ouKG7YNdV4bUJcBV0W3dBAType(System.IntPtr server);
        private static unsafe readonly CesiumForUnity_SelectIonTokenWindow_CallShowWindow_ouKG7YNdV4bUJcBV0W3dBAType CesiumForUnity_SelectIonTokenWindow_CallShowWindow_ouKG7YNdV4bUJcBV0W3dBADelegate = new CesiumForUnity_SelectIonTokenWindow_CallShowWindow_ouKG7YNdV4bUJcBV0W3dBAType(CesiumForUnity_SelectIonTokenWindow_CallShowWindow_ouKG7YNdV4bUJcBV0W3dBA);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_SelectIonTokenWindow_CallShowWindow_ouKG7YNdV4bUJcBV0W3dBAType))]
        private static unsafe void CesiumForUnity_SelectIonTokenWindow_CallShowWindow_ouKG7YNdV4bUJcBV0W3dBA(System.IntPtr server)
        {
            CesiumForUnity.SelectIonTokenWindow.ShowWindow((CesiumForUnity.CesiumIonServer)Reinterop.ObjectHandleUtility.GetObjectFromHandle(server)!);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr CesiumForUnity_SelectIonTokenWindow_Field_get_serverType(System.IntPtr thiz);
        private static unsafe readonly CesiumForUnity_SelectIonTokenWindow_Field_get_serverType CesiumForUnity_SelectIonTokenWindow_Field_get_serverDelegate = new CesiumForUnity_SelectIonTokenWindow_Field_get_serverType(CesiumForUnity_SelectIonTokenWindow_Field_get_server);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_SelectIonTokenWindow_Field_get_serverType))]
        private static unsafe System.IntPtr CesiumForUnity_SelectIonTokenWindow_Field_get_server(System.IntPtr thiz)
        {
            var result = ((CesiumForUnity.SelectIonTokenWindow)ObjectHandleUtility.GetObjectFromHandle(thiz)!).server;
          return Reinterop.ObjectHandleUtility.CreateHandle(result);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void CesiumForUnity_SelectIonTokenWindow_Field_set_serverType(System.IntPtr thiz, System.IntPtr value);
        private static unsafe readonly CesiumForUnity_SelectIonTokenWindow_Field_set_serverType CesiumForUnity_SelectIonTokenWindow_Field_set_serverDelegate = new CesiumForUnity_SelectIonTokenWindow_Field_set_serverType(CesiumForUnity_SelectIonTokenWindow_Field_set_server);
        [AOT.MonoPInvokeCallback(typeof(CesiumForUnity_SelectIonTokenWindow_Field_set_serverType))]
        private static unsafe void CesiumForUnity_SelectIonTokenWindow_Field_set_server(System.IntPtr thiz, System.IntPtr value)
        {
            ((CesiumForUnity.SelectIonTokenWindow)ObjectHandleUtility.GetObjectFromHandle(thiz)!).server = (CesiumForUnity.CesiumIonServer)Reinterop.ObjectHandleUtility.GetObjectFromHandle(value)!;
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void System_Collections_Generic_ListBSSRPFX2rxvf__GnQ_i__RxA_CallAdd_nq8TJwFX_ptyb2rCV3CGswType(System.IntPtr thiz, System.IntPtr item);
        private static unsafe readonly System_Collections_Generic_ListBSSRPFX2rxvf__GnQ_i__RxA_CallAdd_nq8TJwFX_ptyb2rCV3CGswType System_Collections_Generic_ListBSSRPFX2rxvf__GnQ_i__RxA_CallAdd_nq8TJwFX_ptyb2rCV3CGswDelegate = new System_Collections_Generic_ListBSSRPFX2rxvf__GnQ_i__RxA_CallAdd_nq8TJwFX_ptyb2rCV3CGswType(System_Collections_Generic_ListBSSRPFX2rxvf__GnQ_i__RxA_CallAdd_nq8TJwFX_ptyb2rCV3CGsw);
        [AOT.MonoPInvokeCallback(typeof(System_Collections_Generic_ListBSSRPFX2rxvf__GnQ_i__RxA_CallAdd_nq8TJwFX_ptyb2rCV3CGswType))]
        private static unsafe void System_Collections_Generic_ListBSSRPFX2rxvf__GnQ_i__RxA_CallAdd_nq8TJwFX_ptyb2rCV3CGsw(System.IntPtr thiz, System.IntPtr item)
        {
            ((System.Collections.Generic.List<CesiumForUnity.QuickAddItem>)Reinterop.ObjectHandleUtility.GetObjectFromHandle(thiz)!).Add((CesiumForUnity.QuickAddItem)Reinterop.ObjectHandleUtility.GetObjectFromHandle(item)!);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr System_Collections_Generic_ListBSSRPFX2rxvf__GnQ_i__RxA_Construct_1B2M2Y8AsgTpgAmY7PhCfgType();
        private static unsafe readonly System_Collections_Generic_ListBSSRPFX2rxvf__GnQ_i__RxA_Construct_1B2M2Y8AsgTpgAmY7PhCfgType System_Collections_Generic_ListBSSRPFX2rxvf__GnQ_i__RxA_Construct_1B2M2Y8AsgTpgAmY7PhCfgDelegate = new System_Collections_Generic_ListBSSRPFX2rxvf__GnQ_i__RxA_Construct_1B2M2Y8AsgTpgAmY7PhCfgType(System_Collections_Generic_ListBSSRPFX2rxvf__GnQ_i__RxA_Construct_1B2M2Y8AsgTpgAmY7PhCfg);
        [AOT.MonoPInvokeCallback(typeof(System_Collections_Generic_ListBSSRPFX2rxvf__GnQ_i__RxA_Construct_1B2M2Y8AsgTpgAmY7PhCfgType))]
        private static unsafe System.IntPtr System_Collections_Generic_ListBSSRPFX2rxvf__GnQ_i__RxA_Construct_1B2M2Y8AsgTpgAmY7PhCfg()
        {
            
            var result = new System.Collections.Generic.List<CesiumForUnity.QuickAddItem>();
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate void UnityEditor_EditorUtility_CallSetDirty_byPIQUdz9akDU2__zoHd1tgType(System.IntPtr target);
        private static unsafe readonly UnityEditor_EditorUtility_CallSetDirty_byPIQUdz9akDU2__zoHd1tgType UnityEditor_EditorUtility_CallSetDirty_byPIQUdz9akDU2__zoHd1tgDelegate = new UnityEditor_EditorUtility_CallSetDirty_byPIQUdz9akDU2__zoHd1tgType(UnityEditor_EditorUtility_CallSetDirty_byPIQUdz9akDU2__zoHd1tg);
        [AOT.MonoPInvokeCallback(typeof(UnityEditor_EditorUtility_CallSetDirty_byPIQUdz9akDU2__zoHd1tgType))]
        private static unsafe void UnityEditor_EditorUtility_CallSetDirty_byPIQUdz9akDU2__zoHd1tg(System.IntPtr target)
        {
            UnityEditor.EditorUtility.SetDirty((UnityEngine.Object)Reinterop.ObjectHandleUtility.GetObjectFromHandle(target)!);
        }
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate byte UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgType(System.IntPtr x, System.IntPtr y);
        private static unsafe readonly UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgType UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate = new UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgType(UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Callop_Equality_5bi2N6jTkaYVhpHPRxL2Wg);
        [AOT.MonoPInvokeCallback(typeof(UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgType))]
        private static unsafe byte UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Callop_Equality_5bi2N6jTkaYVhpHPRxL2Wg(System.IntPtr x, System.IntPtr y)
        {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate byte UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgType(System.IntPtr x, System.IntPtr y);
        private static unsafe readonly UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgType UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate = new UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgType(UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2Wg);
        [AOT.MonoPInvokeCallback(typeof(UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgType))]
        private static unsafe byte UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2Wg(System.IntPtr x, System.IntPtr y)
        {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Property_get_instanceType();
        private static unsafe readonly UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Property_get_instanceType UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Property_get_instanceDelegate = new UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Property_get_instanceType(UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Property_get_instance);
        [AOT.MonoPInvokeCallback(typeof(UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Property_get_instanceType))]
        private static unsafe System.IntPtr UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Property_get_instance()
        {
            
            var result = UnityEditor.ScriptableSingleton<CesiumForUnity.CesiumIonServerManager>.instance;
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate System.IntPtr UnityEngine_Application_Property_get_temporaryCachePathType();
        private static unsafe readonly UnityEngine_Application_Property_get_temporaryCachePathType UnityEngine_Application_Property_get_temporaryCachePathDelegate = new UnityEngine_Application_Property_get_temporaryCachePathType(UnityEngine_Application_Property_get_temporaryCachePath);
        [AOT.MonoPInvokeCallback(typeof(UnityEngine_Application_Property_get_temporaryCachePathType))]
        private static unsafe System.IntPtr UnityEngine_Application_Property_get_temporaryCachePath()
        {
    ...
    internal class ReinteropInitializer
    {
        ...
        static ReinteropInitializer()
        {
            unsafe
            {
                IntPtr memory = Marshal.AllocHGlobal(sizeof(IntPtr) * 303);
                AddFunctionPointers(memory);
                byte success = initializeReinterop(1912872569339110516UL, memory, 303);
                if (success == 0)
                    throw new NotImplementedException("The native library is out of sync with the managed one.");
            }
        }
